...
[![Codecov test
coverage](https://codecov.io/gh/sanderroberti/ameras/graph/badge.svg)](https://app.codecov.io/gh/sanderroberti/ameras)
<!-- badges: end -->
...
#>      RC  0.021 0.0  0.021
#>     ERC  6.728 0.0  6.728
#>    MCML  0.105 0.0  0.105
#>     FMA  0.177 0.0  0.177
#>     BMA 42.496 0.0 42.496
#> 
...
#> 
#>  Method    Fit    CI  Total
#>      RC  0.021 0.001  0.022
#>     ERC  6.728 0.000  6.728
#>    MCML  0.105 0.000  0.105
#>     FMA  0.177 0.005  0.182
#>     BMA 42.496 0.001 42.497
#> 
#> Summary of coefficients by method:
#> 
...
For visual model diagnostics using residuals, use `plot()`. For example,
