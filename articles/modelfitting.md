...
#>   .. .. ..- attr(*, ".Environment")=<environment: 0x55d40b6ddfe0> 
#>   ..$ X           : int [1:2] 9 10
#>   ..$ offset      : NULL
#>   ..$ entry       : NULL
#>   ..$ exit        : NULL
